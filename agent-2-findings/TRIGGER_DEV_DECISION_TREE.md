...
**Related:** [Tasks API - Trigger](../01-api-docs/01-tasks-api/00-trigger.md) | [Batch Trigger](../01-api-docs/01-tasks-api/01-batch-trigger.md) | [Fan-out Pattern](./TRIGGER_DEV_PATTERNS.md#1-fan-out-batch-trigger-n-subtasks)
...
**Related:** [Queues API - List](../01-api-docs/04-queues-api/00-list-queues.md) | [Override Concurrency](../01-api-docs/04-queues-api/03-override-concurrency-limit.md) | [Pause/Resume](../01-api-docs/04-queues-api/02-pause-or-resume-queue.md) | [Per-Tenant Pattern](./TRIGGER_DEV_PATTERNS.md#3-per-tenant-rate-limiting)
...
**Related:** [Waitpoints API - Create Token](../01-api-docs/08-waitpoints-api/00-create-waitpoint-token.md) | [Complete via HTTP](../01-api-docs/08-waitpoints-api/04-complete-waitpoint-token-via-http-callback.md) | [Human-in-the-Loop Pattern](./TRIGGER_DEV_PATTERNS.md#5-human-in-the-loop) | [Webhook Callback Pattern](./TRIGGER_DEV_PATTERNS.md#6-webhook-callback)
...
**Related:** [Batches API - Create](../01-api-docs/02-batches-api/00-create-batch.md) | [Retrieve Results](../01-api-docs/02-batches-api/02-retrieve-batch-results.md) | [Fan-out Pattern](./TRIGGER_DEV_PATTERNS.md#1-fan-out-batch-trigger-n-subtasks)
...
**Related:** [Schedules API - Create](../01-api-docs/05-schedules-api/01-create-schedule.md) | [List Schedules](../01-api-docs/05-schedules-api/00-list-schedules.md) | [Update Schedule](../01-api-docs/05-schedules-api/03-update-schedule.md) | [Delete Schedule](../01-api-docs/05-schedules-api/04-delete-schedule.md) | [Scheduled Data Sync Pattern](./TRIGGER_DEV_PATTERNS.md#7-scheduled-data-sync)
...
| :--- | :--- | :--- |
| Task vs inline code | All patterns | [Tasks API](../01-api-docs/01-tasks-api/00-trigger.md) |
| `trigger()` vs `triggerAndWait()` | [Sequential Pipeline](./TRIGGER_DEV_PATTERNS.md#2-sequential-pipeline-task-a-to-b-to-c) | [Tasks API](../01-api-docs/01-tasks-api/00-trigger.md) |
| Custom queue vs default | [Per-Tenant Rate Limiting](./TRIGGER_DEV_PATTERNS.md#3-per-tenant-rate-limiting) | [Queues API](../01-api-docs/04-queues-api/00-list-queues.md) |
| `wait.for` vs `wait.forToken` | [Human-in-the-Loop](./TRIGGER_DEV_PATTERNS.md#5-human-in-the-loop), [Webhook Callback](./TRIGGER_DEV_PATTERNS.md#6-webhook-callback) | [Waitpoints API](../01-api-docs/08-waitpoints-api/00-create-waitpoint-token.md) |
| Batch vs loop | [Fan-out](./TRIGGER_DEV_PATTERNS.md#1-fan-out-batch-trigger-n-subtasks) | [Batches API](../01-api-docs/02-batches-api/00-create-batch.md) |
| Schedules vs external cron | [Scheduled Data Sync](./TRIGGER_DEV_PATTERNS.md#7-scheduled-data-sync) | [Schedules API](../01-api-docs/05-schedules-api/01-create-schedule.md) |
