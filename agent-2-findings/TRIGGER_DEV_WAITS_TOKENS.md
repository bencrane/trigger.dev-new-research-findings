...
<!-- UNVERIFIED: Whether combining multiple duration fields is additive is based on common SDK patterns; not explicitly tested against 4.4.3 -->
...
<!-- UNVERIFIED: The 5-second checkpoint threshold is based on Trigger.dev documentation; runs with waits under ~5 seconds may spin-wait instead of checkpointing -->
...
<!-- UNVERIFIED: Idempotency key behavior during retries is based on Trigger.dev docs pattern; exact skip-on-retry semantics may differ -->
...
<!-- UNVERIFIED: inputStream is a higher-level abstraction documented in Trigger.dev but exact API shape and availability in SDK 4.4.3 may differ -->
...
- [Waitpoints API — Create Token](../01-api-docs/08-waitpoints-api/00-create-waitpoint-token.md)
- [Waitpoints API — List Tokens](../01-api-docs/08-waitpoints-api/01-list-waitpoint-tokens.md)
- [Waitpoints API — Retrieve Token](../01-api-docs/08-waitpoints-api/02-retrieve-waitpoint-token.md)
- [Waitpoints API — Complete Token](../01-api-docs/08-waitpoints-api/03-complete-waitpoint-token.md)
- [Waitpoints API — HTTP Callback](../01-api-docs/08-waitpoints-api/04-complete-waitpoint-token-via-http-callback.md)
